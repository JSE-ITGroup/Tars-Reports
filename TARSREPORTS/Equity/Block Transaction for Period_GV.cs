...
namespace TARSREPORTS.Equity {
    ...
    public class Block_Transaction_for_Period_GV : ReportClass {
        
        public Block_Transaction_for_Period_GV() {
        }
        
        public override string ResourceName {
            get {
                return "Block Transaction for Period_GV.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "TARSREPORTS.Equity.Block Transaction for Period_GV.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedBlock_Transaction_for_Period_GV : Component, ICachedReport {
        
        public CachedBlock_Transaction_for_Period_GV() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            Block_Transaction_for_Period_GV rpt = new Block_Transaction_for_Period_GV();
            rpt.Site = this.Site;
            return rpt;
        }
