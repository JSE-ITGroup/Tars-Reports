...
namespace TARSREPORTS.Equity {
    ...
    public class Transaction_Listing_by_Security_GV : ReportClass {
        
        public Transaction_Listing_by_Security_GV() {
        }
        
        public override string ResourceName {
            get {
                return "Transaction Listing by Security_GV.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "TARSREPORTS.Equity.Transaction Listing by Security_GV.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedTransaction_Listing_by_Security_GV : Component, ICachedReport {
        
        public CachedTransaction_Listing_by_Security_GV() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            Transaction_Listing_by_Security_GV rpt = new Transaction_Listing_by_Security_GV();
            rpt.Site = this.Site;
            return rpt;
        }
